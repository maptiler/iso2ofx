 ...
 * @type {Uint8Array}
 */
export var token = new Uint8Array([colonSymbolCode, 54, 52, colonSymbolCode]);
...
var closingAvailableBalance = __assign(__assign({}, openingBalanceTag), { readToken: function (state) {
